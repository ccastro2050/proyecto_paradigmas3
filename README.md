...
> el puerto 8004 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                 STATUS                    PORTS
> proyecto_paradigmas3-api-facturas-1   Up 2 hours                0.0.0.0:8004->8004/tcp
> proyecto_paradigmas3-postgres-1       Up 2 hours (healthy)      0.0.0.0:15434->5432/tcp
> ```
>
...
| Qué | Dónde |
|---|---|
| **API Facturas — Swagger** (probar los endpoints) | http://localhost:8004/docs |
| Diagnóstico | http://localhost:8004/ |
| PostgreSQL (para DBeaver/pgAdmin, opcional) | `localhost:15434` · `paradigmas`/`paradigmas123` |
...
│
├── api_facturas/                # LA API DE LA v1 — FastAPI (puerto 8004)
