...
| **v3** | [v3_segundo_motor/](v3_segundo_motor/2_spec.md) — **En curso** | Lo mismo, ahora también contra **MariaDB** | Nace `DB_PROVIDER` y la **fábrica** — abierto/cerrado en acción: cero cambios en controllers y servicios |
