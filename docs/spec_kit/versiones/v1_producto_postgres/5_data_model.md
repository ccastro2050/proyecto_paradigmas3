...
```
# API corriendo LOCAL (venv + uvicorn), la BD publica el puerto 15434 al host:
postgresql+asyncpg://paradigmas:paradigmas123@localhost:15434/bdfacturas_postgres_local
