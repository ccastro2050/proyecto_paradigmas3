...
CAPA 2: API (FastAPI)        — api_facturas :8004
...
| Cosa | Convención |
|---|---|
| Puertos públicos | front 8000 · · api_facturas 8004 · phpMyAdmin 8081 |
...
| Hosts internos (entre contenedores) | `postgres:5432` · `mariadb:3306` · `sqlserver:1433` · `api-facturas:8004` |
